...
<form action="/articulos/{{$articulo->id}}" method="POST">
    ...
    <div class="mb-3">
        ...
        <input id="codigo" name="codigo" type="text" class="form-control" value="{{$articulo->codigo}}" tabindex="1" autofocus>
    </div>
    <div class="mb-3">
    ...
    <a href="/articulos" class="btn btn-secondary" tabindex="5">Cancelar</a> <button type="submit" class="btn btn-primary" tabindex="4">Guardar</button>
</form>
@endsection